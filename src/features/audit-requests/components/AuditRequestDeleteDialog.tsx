...
interface AuditRequestDeleteDialogProps {
...
function AuditRequestDeleteDialog({
	auditRequest,
	isDeleting,
	onCancel,
	onConfirm,
}: AuditRequestDeleteDialogProps) {
		...
		>
			...
			>
				...
				<div className='mt-4 flex flex-wrap items-center gap-2'>
					...
					>
						{isDeleting
							? t('auditRequests.deleteDialog.deleting')
							: t('auditRequests.deleteDialog.confirm')}
					</button>
				</div>
			</section>
		</div>
...
export default AuditRequestDeleteDialog
